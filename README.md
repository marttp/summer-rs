...
| `summer-resilience`     | [![summer-resilience](https://img.shields.io/crates/v/summer-resilience.svg)](https://summer-rs.github.io/docs/plugins/summer-resilience/)             | [`backoff`](https://github.com/ihrwein/backoff) / [`failsafe`](https://github.com/dmexe/failsafe-rs) | Retry, circuit breaker, and timeout policies      |
